...
edge_evidence_has_drug_response: Final[AcquisitionDefinition[EdgeInfo]] = ExpressionEdgeAcquisitionDefinition(
    ...
    primary_id=get_arrow_expression(
        FieldEvidenceId,
        get_arrow_expression(FieldEvidenceDrugResponseDrugId, FieldEvidenceDrugResponseResponse),
    ),
    source=FieldEvidenceId,
    target=get_arrow_expression(FieldEvidenceDrugResponseDrugId, FieldEvidenceDrugResponseResponse),
