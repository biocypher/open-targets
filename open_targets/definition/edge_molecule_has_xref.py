"""Acquisition definition that acquires 'has cross-reference' edges for molecules."""
...
edge_molecule_has_xref: Final[AcquisitionDefinition[EdgeInfo]] = ExpressionEdgeAcquisitionDefinition(
